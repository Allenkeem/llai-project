...
- **파일**: `data/raw/court/judges_by_region.csv`
  ...
  - ⚠ **지원은 '물리적 시'가 아니라 '소속 지방법원' 기준**으로 합산해야 사건(A2)·변호사(A1)와
    정합한다. 예: **부천지원→인천지법→인천**(경기 아님), 고양지원→의정부지법→경기.
    근거: 사법연감 관내가 지방법원 단위이고, **변호사법 제64조(지방변호사회는 지방법원 관할마다 1개)**
    에 따라 변호사회도 지법 관할을 따른다 → 부천 변호사는 인천지방변호사회 소속. 즉 **판사수·사건·변호사
    3축 모두 인천으로 정합**(경기중앙회는 수원지법 관할이라 부천 미포함).
- **활성화**:
  ```bash
